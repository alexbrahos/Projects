...
public class SeventhsQuiz extends MajorMinorQuiz{
  ...
  public SeventhsQuiz() {
    System.out.println("Sevenths null constructor");
  }
  

  public SeventhsQuiz(int userNum) {
  ...
  public void writeQuestion(){
    ...
    chosenInterval = (int)(Math.random()*5); //choose the type of chord
    lives = 3;
    nextQuestion = false;

    String[] allNotes = {"C", "C#", "D", "D#", "E", "F", "F#", "G", "G#", "A", "A#", "B"};
    String[] intervals = {"Maj7", "7", "min7", "halfdim7", "dim7"};
    ...
    if (chosenInterval == 0){ //major7
      ...
      correctNotes[tempNum] = true;
    } else if (chosenInterval == 3){ //halfdim7
      tempNum += 3;
      if (tempNum > 11){ //if the number is too high, loop around
        tempNum -= 12;
      } //end if
